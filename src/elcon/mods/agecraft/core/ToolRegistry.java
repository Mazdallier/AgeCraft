...
public class ToolRegistry {
	...
	public static void registerTool(Tool tool) {
		if(tools[tool.id] != null) {
			ACLog.warning("[ToolRegistry] Overriding existing tool (" + tools[tool.id].id + ": " + tools[tool.id].name.toUpperCase() + ") with new tool (" + tool.id + ": " + tool.name.toUpperCase() + ")");
		}
		tools[tool.id]= tool;
	}
	...
	public static void registerToolMaterial(ToolMaterial toolMaterial) {
		if(toolMaterials[toolMaterial.id] != null) {
			ACLog.warning("[ToolRegistry] Overriding existing tool material (" + toolMaterials[toolMaterial.id].id + ": " + toolMaterials[toolMaterial.id].name.toUpperCase() + ") with new tool material (" + toolMaterial.id + ": " + toolMaterial.name.toUpperCase() + ")");
		}
	...
	public static void registerToolRodMaterial(ToolRodMaterial toolRodMaterial) {
		if(toolRodMaterials[toolRodMaterial.id] != null) {
			ACLog.warning("[ToolRegistry] Overriding existing tool rod material (" + toolRodMaterials[toolRodMaterial.id].id + ": " + toolRodMaterials[toolRodMaterial.id].name.toUpperCase() + ") with new tool rod material (" + toolRodMaterial.id + ": " + toolRodMaterial.name.toUpperCase() + ")");
		}
	...
	public static void registerToolEnhancementMaterial(ToolEnhancementMaterial toolEnhancementMaterial) {
		if(toolEnhancementMaterials[toolEnhancementMaterial.id] != null) {
			ACLog.warning("[ToolRegistry] Overriding existing tool enhancement material (" + toolEnhancementMaterials[toolEnhancementMaterial.id].id + ": " + toolEnhancementMaterials[toolEnhancementMaterial.id].name.toUpperCase() + ") with new tool enhancement material (" + toolEnhancementMaterial.id + ": " + toolEnhancementMaterial.name.toUpperCase() + ")");
		}
