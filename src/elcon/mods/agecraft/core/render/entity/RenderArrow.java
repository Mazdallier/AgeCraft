package elcon.mods.agecraft.core.render.entity;
...
public class RenderArrow extends Render {
	...
	public void doRender(Entity entity, double x, double y, double z, float f1, float f2) {
		bindTexture(getArrowHeadTexture((EntityArrow) entity));
		renderArrow((EntityArrow) entity, x, y, z, f1, f2);
		bindTexture(getArrowRodTexture((EntityArrow) entity));
		renderArrow((EntityArrow) entity, x, y, z, f1, f2);
	}

	public void renderArrow(EntityArrow entity, double x, double y, double z, float f1, float f2) {
		GL11.glPushMatrix();
		...
		float shake = (float) entity.arrowShake - f2;
		if(shake > 0.0F) {
	...
	public ResourceLocation getArrowHeadTexture(EntityArrow entity) {
		return ResourcesCore.arrowHeads[entity.getMaterial()];
	}

	public ResourceLocation getArrowRodTexture(EntityArrow entity) {
		return ResourcesCore.arrowRods[entity.getRodMaterial()];
	}
