...
public class RenderEntityBlock extends Render {
	...
	public static class RenderBlockInfo {
		...
		public RenderBlockInfo(Block template, Icon[] texture) {
			this();
	...
	public void doRenderBlock(EntityBlock entity, double i, double j, double k) {
		...
		RenderBlockInfo util = new RenderBlockInfo();
	...
	public void renderBlock(RenderBlockInfo info, IBlockAccess blockAccess, int x, int y, int z, boolean doLight, boolean doTessellating) {
		renderBlock(info, blockAccess, x, y, z, x, y, z, doLight, doTessellating);
	}

	public void renderBlock(RenderBlockInfo info, IBlockAccess blockAccess, double x, double y, double z, int lightX, int lightY, int lightZ, boolean doLight, boolean doTessellating) {
