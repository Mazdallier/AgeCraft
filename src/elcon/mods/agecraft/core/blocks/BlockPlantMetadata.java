...
public class BlockPlantMetadata extends BlockMetadata implements IPlantable {

	public BlockPlantMetadata(int i, Material material) {
		super(i, material);
		setTickRandomly(true);
		setBlockBounds(0.3F, 0.0F, 0.3F, 0.7F, 0.6F, 0.7F);
	}

	public BlockPlantMetadata(int i) {
