...
import elcon.mods.agecraft.ACUtilClient;
...
public class BlockExtendedMetadataOverlay extends BlockContainerOverlay implements IBlockExtendedMetadata {
	...
	public boolean addBlockDestroyEffects(World world, int x, int y, int z, int meta, EffectRenderer effectRenderer) {
		return ACUtilClient.addBlockDestroyEffects(world, x, y, z, meta, effectRenderer, this, getMetadata(world, x, y, z));
	}
	...
	public boolean addBlockHitEffects(World world, MovingObjectPosition target, EffectRenderer effectRenderer) {
		...
		int y = target.blockY;
		int z = target.blockZ;
		return ACUtilClient.addBlockHitEffects(world, target, effectRenderer, getMetadata(world, x, y, z));
	}
