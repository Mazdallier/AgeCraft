...
public class BlockStoneBrick extends BlockExtendedMetadataOverlay {
	...
	public void registerIcons(IconRegister iconRegister) {
		...
		chiseledTop = iconRegister.registerIcon("agecraft:stone/stoneBrickChiseledTop");
		overlayMossy = iconRegister.registerIcon("agecraft:stone/stoneBrickMossyOverlay");
	}
