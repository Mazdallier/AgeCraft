...
public class ACReference {
	...
	public static final String DEPENDENCIES = "required-after:Forge@[10.12.0.1024,);required-after:ElConCore";
	public static final String SERVER_PROXY_CLASS = "org.agecraft.ACCommonProxy";
    public static final String CLIENT_PROXY_CLASS = "org.agecraft.ACClientProxy";
