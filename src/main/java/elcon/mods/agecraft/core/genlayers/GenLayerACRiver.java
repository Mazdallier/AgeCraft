...
public class GenLayerACRiver extends GenLayer {
	
	public int dimension = 0;

	public GenLayerACRiver(long seed, GenLayer genLayer, int dim) {
		super(seed);
		parent = genLayer;
		dimension = dim;
	}
		...
		for(int var11 = 0; var11 < par4; ++var11) {
			for(int var12 = 0; var12 < par3; ++var12) {
				...
				if(var17 != 0 && var13 != 0 && var14 != 0 && var15 != 0 && var16 != 0 && var17 == var13 && var17 == var15 && var17 == var14 && var17 == var16) {
					...
					var10[var12 + var11 * par3] = getRiverForDimension(dimension).biomeID;
				}
			}
		}
	...
	private BiomeGenBase getRiverForDimension(int dim) {
		if(dim == 10) {
			return BiomeGenACPrehistory.prehistoryRiver;
		}
