...
import org.agecraft.prehistory.recipes.RecipesSharpener.RecipeSharpener;
...
public class ContainerSharpener extends Container {
	...
	public void onCraftMatrixChanged(IInventory inv) {
		...
		if(!rockRemoved) {
			player.inventory.consumeInventoryItem(Item.getItemFromBlock(PrehistoryAge.rock));
			rockRemoved = true;
		}
		if(initDone) {
			...
			if(r != null) {
				...
				inventory.setInventorySlotContents(1, new ItemStack(r.output.getItem(), 1, rand.nextInt(8)));
			} else {
