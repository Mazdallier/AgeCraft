...
public class ItemMetalDoor extends ItemBlockExtendedMetadata {
	...
	public ItemMetalDoor(Block block) {
		super(block);
	}
	...
	public int getColorFromItemStack(ItemStack stack, int renderPass) {
		return renderPass == 0 ? MetalRegistry.instance.get((stack.getItemDamage() - (stack.getItemDamage() & 127)) / 128).metalColor : super.getColorFromItemStack(stack, renderPass);
	}
