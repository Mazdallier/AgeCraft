...
public class WrappedStack implements Comparable<WrappedStack> {
	...
	public int hashCode() {
		...
		if(isItemStack()) {
			hashCode = (37 * hashCode) + getItemStack().getItem().hashCode();
	...
	public String toString() {
		...
		if(isItemStack()) {
			sb.append(String.format("%sxItemStack[%s:%s:%s]", getStackSize(), getItemStack().getUnlocalizedName(), getItemStack().getItemDamage(), getItemStack().getUnlocalizedName()));
		} else if(isFluidStack()) {
