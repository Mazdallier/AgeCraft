...
public class ACCreativeTabs {
	...
	public static CreativeTabs prehistoryAge = new CreativeTabAgePrehistory(20, "Prehistory");
	public static CreativeTabs agricultureAge = new CreativeTabAgeAgriculture(21, "Agriculture");
